...
public class ExpressionTypeAnalyzer
{
    ...
    public ExpressionTypeAnalyzer(TypeRepository typeRepository, TypeResolver typeResolver, FunctionResolver functionResolver, MemoryLayoutManager memoryLayoutManager)
    {
